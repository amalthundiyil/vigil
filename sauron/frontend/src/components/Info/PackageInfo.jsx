    ...
    <div className="featured">
      <div className="featuredItem">
        ...
        <span className="featuredSub">
          Package info......... She considered the birds to be her friends.
          She'd put out food for them each morning and then she'd watch as they
          came to the feeders to gorge themselves for the day.
        </span>
      </div>
      <div className="featuredItem">

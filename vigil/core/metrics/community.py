...
DESCRIPTIONS = {
    ...
    "bus_factor": {
        "HIGH": "Low risk of project collapse, even if a few contributors leave",
...
SUMMARY_DESC = {
    "HIGH": "Community is active and has a strong code of conduct",

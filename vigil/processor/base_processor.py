...
from vigil.processor.base_backend import BaseBackend

LOG = logging.getLogger("vigil.processor.base_processor")
...
def get_summary(key):
    from vigil.processor.metrics import community, maintainence, popularity
    from vigil.processor.processors import security
...
def processor_mapping(domain):
    from vigil.processor.processors.community import CommunityProcessor
    from vigil.processor.processors.maintainence import MaintainenceProcessor
    from vigil.processor.processors.popularity import PopularityProcessor
    from vigil.processor.processors.security import SecurityProcessor
